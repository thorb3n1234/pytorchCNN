...
def read_file(file_path):
    ...
    img = Image.open("{}/{}".format("train", image_file_name))
  #  print(str(image_file_name))
    w, h = img.size
    with open("{}/{}".format("train",file_path), 'r') as file:
...
def start():
    ...
    for filename in os.listdir(ANNOTATIONS_DIR_PREFIX):
        if filename.endswith('txt') and str(filename)!= "classes.txt":
            read_file(filename)
        else:
